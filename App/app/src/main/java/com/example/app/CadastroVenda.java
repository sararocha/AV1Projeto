...
public class CadastroVenda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void calcular() {
            double n1 = Double.parseDouble(editPreco.getText().toString());
            double n2 = Double.parseDouble(editImposto.getText().toString());

            double result = n1 + (n2 * n1);

            txtCalculo.setText("Preço final: " + result);
